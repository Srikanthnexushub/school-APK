    ...
    <div className="p-4 lg:p-8 space-y-6 max-w-7xl mx-auto">
          ...
          {linkedStudents.map((s) => (
            ...
            >
              ...
              <div className="text-left">
                ...
                <div className="text-xs text-white/40">Student ID: {s.studentId.slice(0, 8)}…</div>
              </div>
            </button>
          ))}
        </div>
      ...
      {linkedStudents.length === 0 && (
        <div className="card text-center py-12">
          ...
          <p className="text-white/50 text-sm">No linked students found.</p>
          <p className="text-white/30 text-xs mt-1">Contact your center to link a student to your account.</p>
        </div>
      )}
