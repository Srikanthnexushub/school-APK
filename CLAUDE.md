...
| VIDEO Banner type — autoplay muted video advertisements, V18 migration (video_url column), BannerType.VIDEO, VideoBanner.tsx (Intersection Observer pause-on-scroll, real-time progress bar, play/pause+mute controls, AnimatePresence), VIDEO option in admin form with rose badge | `center-svc: V18, BannerType.java, Banner.java, BannerResponse, CreateBannerRequest, UpdateBannerRequest, BannerService, BannerControllerIT`; `frontend: VideoBanner.tsx, AdvertisementBanner.tsx, AdminBannersPage.tsx, AdminDashboardPage.tsx, ParentDashboardPage.tsx` | ef1b472 |
