package com.edutech.aigateway.architecture;
...
@DisplayName("ai-gateway-svc Architecture Rules")
class ArchitectureRulesTest {
    ...
    static void load() {
        classes = new ClassFileImporter()
            ...
            .importPackages("com.edutech.aigateway");
    }
    ...
    void servicesMustResideInApplicationService() {
        // Only check classes ending in 'Service' that are @Service-annotated
