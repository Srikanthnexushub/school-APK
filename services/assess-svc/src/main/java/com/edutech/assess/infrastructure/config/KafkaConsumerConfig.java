// src/main/java/com/edutech/assess/infrastructure/config/KafkaConsumerConfig.java
...
/**
 * Kafka consumer hardening for assess-svc.
 *
 * <ul>
 *   <li>ErrorHandlingDeserializer wraps JsonDeserializer — malformed/non-JSON messages
 *       are logged and skipped instead of blocking the partition.</li>
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, String> assessStringConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String>
        ...
        factory.setConsumerFactory(assessStringConsumerFactory());
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                (record, ex) -> log.error(
                        "assess-svc Kafka consumer skipped unprocessable record: " +
