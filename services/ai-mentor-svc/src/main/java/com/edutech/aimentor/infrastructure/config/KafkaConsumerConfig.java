...
/**
 * Kafka consumer configuration for ai-mentor-svc.
 *
 * Hardening applied:
 * <ul>
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, String> aiMentorConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String>
        ...
        factory.setConsumerFactory(aiMentorConsumerFactory());
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                (record, ex) -> log.error(
                        "AI-mentor consumer skipped unprocessable record: " +
