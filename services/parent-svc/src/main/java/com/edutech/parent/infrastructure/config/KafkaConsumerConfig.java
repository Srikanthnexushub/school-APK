// src/main/java/com/edutech/parent/infrastructure/config/KafkaConsumerConfig.java
...
/**
 * Kafka consumer hardening for parent-svc.
 *
 * <ul>
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, String> parentStringConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, String>
        ...
        factory.setConsumerFactory(parentStringConsumerFactory());
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                (record, ex) -> log.error(
                        "parent-svc Kafka consumer skipped unprocessable record: " +
