package com.edutech.parent.infrastructure.security;
...
/**
 * Allows trusted internal services (e.g. center-svc) to call parent-svc
 ...
 *
 * Runs BEFORE the JWT filter so it takes precedence on service-to-service calls.
 */
@Component
