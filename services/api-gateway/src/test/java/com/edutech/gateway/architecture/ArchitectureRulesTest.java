package com.edutech.gateway.architecture;
...
@DisplayName("API Gateway Architecture Rules")
class ArchitectureRulesTest {
    ...
    static void loadClasses() {
        classes = new ClassFileImporter()
                ...
                .importPackages("com.edutech.gateway");
    }
    ...
    void noJpaAnnotations() {
        ArchRule rule = noClasses()
                ...
                .because("API gateway has no database — no JPA entities allowed");
        rule.check(classes);
    }
    ...
    void noServiceAnnotation() {
        ArchRule rule = noClasses()
                .that().resideInAPackage("com.edutech.gateway..")
