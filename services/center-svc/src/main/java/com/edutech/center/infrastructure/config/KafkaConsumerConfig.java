...
/**
 * Kafka consumer configuration for center-svc.
 *
 * <p>Hardening applied:
 * <ul>
...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, Object> centerConsumerFactory() {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, Object> kafkaListenerContainerFactory() {
        ...
        factory.setConsumerFactory(centerConsumerFactory());
        ...
        DefaultErrorHandler errorHandler = new DefaultErrorHandler(
                (record, ex) -> log.error(
                        "center-svc consumer skipped unprocessable record: topic={} partition={} offset={} error={}",
